<section class="last_ads">
    <div class="container">
        <div class="pre_top aler">
            <h1 class="title">{!! $seo['site_settings_main_titleh1'] !!}</h1>
            <!-- <a href="#">{{ trans('messages.All items') }}</a> -->
        </div>
        <div class="lasts_main" id="divScroll">
            ...
            <div class="row col-12">
                <a class="btn-success__border mr-auto ml-auto" href="{{ route('items-gallery') }}">{{ trans('messages.All items') }}</a>
            </div>
        </div>
    </div>
</section>
