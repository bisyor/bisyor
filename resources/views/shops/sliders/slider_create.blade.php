...
@section('title') {{ trans('messages.Create slider') }} @endsection
@section('content')
        ...
        <div class="container">
            <nav aria-label="breadcrumb" class="my_nav">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ trans('messages.Create slider') }}</li>
                </ol>
            </nav>
            <div class="row pb-3">
                @include('users.left_sidebar', ['user' => $user])
                <div class="col-xl-9 col-md-8">
                    <form action="{{ route('shops-slider-save') }}" method="POST" autocomplete="off"
                        ...
                        <div class="niked">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="link" id="site" value="{{ old('link') }}"
                        ...
                        <div class="pre_file">
                            <div class="pre_file_img ml-2" style="background-image: url('{{ config('app.trashPath').old('temp_address') ?:config('app.noImage') }}')">
                            </div>
