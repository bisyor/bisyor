...
@endforeach
    ...
    <meta property="og:site_name" content="{{ strip_tags($seo['shops_view_site_name']) }}">
                ...
                <div class="bren_mag_right">
                    <div class="rest">
                        ...
                        <div class="rest_bottom">
                            <div class="tabs_rest">
                                <ul class="link_tab">
                                    <li><a href="javascript:void(0);" class="active">@lang('messages.Products')</a></li>
                                    <li><a href="{{ route('shops-about', ['keyword' => $shop['keyword']]) }}">@lang('messages.About brend')</a></li>
                            ...
                            <div class="tab_rest_body">
                                <div class="tab_products">
                                    {{-- Items list --}}
                                    @include('shops.shop_card_item_list', ['items' => $items])
                                </div>
                                @if($items)
                                    <noscript>
                                        <div class="row col-12 mb-3">
                                            <a class="btn-success__border mr-auto ml-auto"
                                               href="{{ route('shops-view', ['page' => $page, 'keyword' => $shop['keyword']]) }}">
...
@section('extra-js')
    ...
    <script>
        ...
        function init() {
            ...
            const cord_x = $('#coordinate_x').val() * 1;
            const cord_y = $('#coordinate_y').val() * 1;
