        ...
        <div class="container">
            <nav aria-label="breadcrumb" class="my_nav">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ trans('messages.Sliders') . " " . $shop['name'] }}</li>
                </ol>
            </nav>
                        ...
                        <div class="rest_bottom">
                            <div class="tabs_rest">
                                <ul class="link_tab">
                                    ...
                                    <li><a href="javascript:void(0);" class="active">@lang('messages.Portfolio')</a></li>
                                </ul>
                            ...
                            <div class="tab_rest_body">
                                <div class="tab_products portfolios">
                                    @forelse($shop['slides'] as $slide)
                                        <div class="product_mains">
                                            <a href="{{ route('away', ['link' => $slide->link]) }}" class="product_item">
                                                <img src="{{ $slide->getImage() }}">
                                            </a>
                                        </div>
                                        @empty
                                            <div class="free_score mr-auto ml-auto">
