    ...
    <div class="panel-body" style="padding: 0px;">
        <div style="margin:0;">
            <ul class="nav nav-tabs">
                <li id="tab-1"><a href="#default-tab-1" data-toggle="tab">Новые жалобы</a></li>
                <li id="tab-2"><a href="#default-tab-2" data-toggle="tab">Старые жалобы</a></li>
            </ul>
            <div class="tab-content">
                ...
                <div class="tab-pane fade in" id="default-tab-2">
                    <?= $this->render('tab',[
                        'searchModel' => $searchModelInactive,
...
$this->registerJs(<<<JS
    var active_tab = getCookie('tab-claims');
