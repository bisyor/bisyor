...
$this->params['breadcrumbs'][] = ['label' => "Пользователи", 'url' => ['/users/users/index']];
                            ...
                            <div class="panel-inverse">
                                <div class="panel-heading for-phones">
                                    <h4 class="panel-title">Дополнительные телефонные номеры
                                        <?php $pcount = !empty($model->phones) ? count($model->phones) : 0;
                                        if($pcount != $limit):?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group pull-right">
                    <?= Html::a('<span class="fa fa-angle-double-left"></span> Назад', ['/users/users/view', 'id' => $model->id], ['class' => 'btn btn-inverse',]); ?>
