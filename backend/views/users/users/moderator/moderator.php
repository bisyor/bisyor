...
/* @var $searchModel backend\models\searchs\UsersSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Список модераторов';
...
<div class="panel panel-inverse user-index">
    <div class="panel-heading">
        <div class="panel-heading-btn">
            <?= Html::a('Добавить <i class="fa fa-plus"></i>', ['create-moderator'],
                    ['role'=>'modal-remote','title'=> 'Добавить пользователя','class'=>'btn btn-xs btn-success']);?>
        ...
        <h4 class="panel-title">Список модераторов </h4>
    </div>
    <div class="panel-body">
        <div id="ajaxCrudDatatable">
            ...
            'columns' => require(__DIR__.'/_columns_moderator.php'),
