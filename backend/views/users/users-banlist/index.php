...
/* @var $searchModel backend\models\users\UsersBanList */
...
<div class="panel panel-inverse user-index">
    <div class="panel-heading">
        <div class="panel-heading-btn">
            <?= Html::a('<i class="fa fa-plus"></i> Заблокировать доступ', ['create'],
                    ['role'=>'modal-remote','title'=> 'Заблокировать доступ','class'=>'btn btn-xs btn-success']);?>
        ...
        <h4 class="panel-title">Блокировка пользователей </h4>
    </div>
