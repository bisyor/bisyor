...
$this->params['breadcrumbs'][] = 'Магазины';
?>
...
<div class="panel panel-inverse panel-with-tabs" data-sortable-id="ui-unlimited-tabs-1">
    <div class="panel-heading p-0">
        ...
        <div class="tab-overflow overflow-right">
            <ul class="nav nav-tabs nav-tabs-inverse">
                ...
                <li class="active"><a href="#nav-tab-1" data-toggle="tab" aria-expanded="false">Поиск (все категории)</a></li>
                <li class=""><a href="#nav-tab-2" data-toggle="tab" aria-expanded="false">Поиск в категории магазинов</a></li>
                <li class=""><a href="#nav-tab-3" data-toggle="tab" aria-expanded="false">Просмотр магазина</a></li>
    ...
    <div class="tab-content">
        <div class="tab-pane fade active in" id="nav-tab-1">
            <?= $this->render('shops/all-categories', [
                'langs' => $langs,
                'model' => $model,
                'titles' => $titles,
                'form' => $form,
        ...
        <div class="tab-pane fade" id="nav-tab-2">
            <?= $this->render('shops/category-view', [
                'langs' => $langs,
                'model' => $model,
                'titles' => $titles,
                'form' => $form,
        ...
        <div class="tab-pane fade" id="nav-tab-3">
            <?= $this->render('shops/search-category', [
                'langs' => $langs,
                'model' => $model,
                'titles' => $titles,
                'form' => $form,
