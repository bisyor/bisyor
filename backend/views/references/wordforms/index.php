...
/* @var $searchModel backend\models\searchs\WordformsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Поисковые фразы';
...
<div class="panel panel-inverse user-index">
    <div class="panel-heading">
        <div class="panel-heading-btn">
            <a href="wordforms/create" role="modal-remote" class="btn btn-xs  btn-success">Добавить <i class="fa fa-plus"></i> </a>
