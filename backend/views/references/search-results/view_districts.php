...
$this->params['breadcrumbs'][] = $searchRes->query;
...
<div class="panel panel-inverse user-index">
    <div class="panel-heading">
        <div class="panel-heading-btn">
            <a href="/references/search-results/view?id=<?= $searchRes->id?>" data-pjax="0" class="btn btn-xs btn-warning">Назад</a>
        ...
        <h4 class="panel-title">Поисковая фраза : <?=$searchRes->query?></h4>
    </div>
    <div class="panel-body">
        <div id="ajaxCrudDatatable">
            <?=GridView::widget([
                ...
                'columns' => require(__DIR__.'/_columns_districts.php'),
