...
return [
    ...
    [
        ...
        'content' => function($data){
            if($data->region_id != null) return $data->region->name;
        ...
        'buttons'=>[
            'leadView' => function ($url, $model) {
                if ($model->region_id != null) {
                    $url = Url::to(['/references/search-results/view-districts', 'pid' => $model->pid, 'region_id' => $model->region_id]);
            ...
            'leadDelete' => function ($url, $model) {
                    $url = Url::to(['/references/search-results/delete-view', 'pid' =>$model->pid ,'region_id' => $model->region_id]);
