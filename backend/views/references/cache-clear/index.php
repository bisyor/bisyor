...
<div class="panel panel-inverse user-index">
    <div class="panel-heading">
        <div class="panel-heading-btn">
            <a href="https://bisyor.uz/clear-cache" target="_blank" class="btn btn-xs  btn-danger">Очистить кэш </i> </a>
            <a href="/references/cache-clear/create" role="modal-remote" class="btn btn-xs  btn-success">Добавить <i class="fa fa-plus"></i> </a>
        ...
        <h4 class="panel-title">Очистить кэш </h4>
    </div>
