...
/* @var $searchModel backend\models\references\SettingsSearch */
...
<div class="panel panel-inverse user-index">
    <div class="panel-heading">
        <div class="panel-heading-btn">
            <a href="settings/create" role="modal-remote" class="btn btn-xs  btn-success">Добавить <i class="fa fa-plus"></i> </a>
