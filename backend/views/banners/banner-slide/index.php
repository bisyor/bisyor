...
/* @var $searchModel backend\models\searchs\BannersItemsSearch */
...
<div class="panel panel-inverse user-index">
    <div class="panel-heading">
        <div class="panel-heading-btn">
            <a href="/banners/banner-slide/create" data-pjax="0" class="btn btn-xs  btn-success">Добавить <i class="fa fa-plus"></i> </a>
