...
<div class="panel-body" style="padding: 0px;">
    <div style="margin:0;">
        <ul class="nav nav-tabs" id="tab-2-nav">
            <li class="active" id="tab-2-1"><a href="#default-tab-2-1" data-toggle="tab">Общие</a></li>
            <li id="tab-2-2"><a href="#default-tab-2-2" data-toggle="tab">Профиль магазина</a></li>
        </ul>
        <hr>
        <div class="tab-content" id="tab-2-content">
            <div class="tab-pane fade active in" id="default-tab-2-1">
                <?= $this->render('tab1',[
                    'model' => $model,
                    'tab' => 'tab-1',
                    'form' => $form,
            ...
            <div class="tab-pane fade in" id="default-tab-2-2">
                <?= $this->render('tab2',[
                    'model' => $model,
                    'tab' => 'tab-2',
                    'form' => $form,
    ...
    <div class="panel-footer">
        <?= Html::submitButton('Сохранить настройки', ['class' => 'btn btn-success','name' => 'tab-2-submit button']) ?>
    </div>
</div>
