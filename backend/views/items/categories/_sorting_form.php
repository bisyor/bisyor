...
<div class="scorm-form">
    <?php $form = ActiveForm::begin([
        'options' => 
            [
                'id' => 'items-categories-sorting-form'
            ]
    ]); ?>
    <input type="hidden" name="sort" id="sort-category-items">
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            ...
            <div class="panel-footer">
                ...
                <?= Html::a('Назад', ['/items/categories/index'],['class' => 'btn btn-inverse pull-left']) ?>
            </div>
        </div>
...
$("#items-categories-sorting-form").on('submit',function(){
    mouseDown();
});
mouseDown = function(){
    arr = [];
    ...
    $("#sort-category-items").val(arr.join(","));
}
JS
)
?>