...
//    ],
    ...
    [
        ...
        'filterInputOptions' => ['id' => 'promocode-select-type-2'],
        'filterWidgetOptions' => [
            'size' => Select2::MEDIUM,
    ...
    [
        ...
        'filterType' => GridView::FILTER_SELECT2,
        'filterInputOptions' => ['id' => 'promocode-select-usage-2'],
        'filterWidgetOptions' => [
            'size' => Select2::MEDIUM,
            'options' => ['prompt' => 'Выберите'],
            'pluginOptions' => ['allowClear' => true],
...
//    ],
    ...
    [
        ...
        'filterInputOptions' => ['id' => 'promocode-date-active-2'],
        'filterWidgetOptions' => [
            'layout' => '{input}{picker}',
            'options' => ['prompt' => 'Выберите'],
    ...
    [
        ...
        'filter' => DatePicker::widget(['language' => 'ru',
            'name' => 'search_created_date']),
        'filterType' => GridView::FILTER_DATE,
        'filterInputOptions' => ['id' => 'promocode-date-to-2'],
        'filterWidgetOptions' => [
            'layout' => '{input}{picker}',
            'options' => ['prompt' => 'Выберите'],
            'pluginOptions' => ['format' => 'dd.mm.yyyy', 'autoclose' => true],
