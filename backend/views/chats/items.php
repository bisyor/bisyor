...
<div class="content-frame-right" style=" height: 100vh; overflow-y: auto;">
    <div class="list-group list-group-contacts border-bottom push-down-10">
        <?php foreach ($usersList['results'] as $value) {
            ...
            ?>
            <a href="#" onclick="window.location.href='/chats/index?chat_id=<?= $value['chat_id'];?>&page=<?=$pagination?>&type=<?=$type?>&item_id=<?= $item_id?>'" class="list-group-item btnSetUsername"  style="background-color: <?=$color?>;">
