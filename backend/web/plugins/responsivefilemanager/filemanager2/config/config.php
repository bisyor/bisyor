...
$version = "9.14.0";
$host = [
    'name' => 'ftp22.hostland.ru',
    'username' => 'host1804471_imgbisyor2020',
    'password' => 'ocpLJlNw'
];
if (session_id() == '') {
    session_start();
...
$config = array(
    ...
    |
    */
    'base_url' => 'http://img.coding-style.uz',
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    'upload_dir' => '/web/uploads/uploads_tinymce/uploads/',
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    'current_path' => '../../../../../backend/web/uploads_tinymce/uploads/',
    ...
    |
    */
    'thumbs_base_path' => '../../../../../backend/web/uploads_tinymce/uploads_thumbs/',
    ...
    */
    ...
    |
    */
    'ftp_host'         => $host['name'], //put the FTP host
    'ftp_user'         => $host['username'],
    'ftp_pass'         => $host['password'],
    'ftp_base_folder'  => '',
    'ftp_base_url'     => 'http://img.coding-style.uz',
    ...
    |---------------------------------------------------------------------------
    */
    'ftp_thumbs_dir' => '/web/uploads/uploads_tinymce/uploads_thumbs/',
    'ftp_ssl' => false,
    'ftp_port' => 21,
