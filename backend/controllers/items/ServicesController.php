...
class ServicesController extends Controller
{
    ...
    public function beforeAction($action)
    {
        ...
        $service = RoleMethods::getAccess($roles , 'bbs', 'svc');
    ...
    {    
        ...
        $dataProvider = $searchModel->searchAdsServices(Yii::$app->request->queryParams);
    ...
    /**
     * skeditordagi textni ichida image upload qiladigan joyi bor.
     * u shu action orqali upload qiladi
     */
