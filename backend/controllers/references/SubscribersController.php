...
use backend\models\searchs\SubscribersSearch;
...
class SubscribersController extends Controller
{
    ...
    public function beforeAction($action)
    {
        ...
        $subscribers = RoleMethods::getAccess($roles , 'subscribers', 'subscribers');
        $listing = RoleMethods::getAccess($roles , 'subscribers', 'subscribers-listing');
        $edit = RoleMethods::getAccess($roles , 'subscribers', 'subscribers-edit');

        if($subscribers && $listing && $edit)
        {
            if($action->id != null)
    ...
    /**
     * Delete an existing Subscribers model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Subscribers model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
